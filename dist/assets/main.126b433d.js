import { r as o } from "./utils.7f2562c3.js";
function i(r) {
...
class d {
  constructor(t, e, s) {
    (this.category = t), (this.dataSource = e), (this.listElement = s);
  }
  async init() {
    let t = await this.dataSource.getData(),
      e = this.filterProductList(t);
    console.log(e), this.renderList(e);
  }
  renderList(t) {
    o(n, this.listElement, t);
  }
  filterProductList(t) {
    return t.filter((e, s) => s < 4);
  }
}
const a = document.querySelector(".product-list");
console.log(a);
const l = new c("tents"),
  u = new d("tents", l, a);
u.init();
