import { a as s } from "./utils.7f2562c3.js";
import { a as c, s as i } from "./product.947718fb.js";
import { P as a } from "./main.126b433d.js";
const o = s(),
  r = new a("tents");
class e {
  constructor(t, d) {
    (this.productId = t), (this.product = {}), (this.dataSource = d);
  }
  async init() {
